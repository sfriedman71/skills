...
- Released skills live at `skills/<name>/SKILL.md`; this is the only install-supported skill root.
...
- Installation is by symlink from `skills/*`; keep docs clear that `incubator/` is not an install target.
